        ...
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand" href="#intro">
                    <img class="logo-default" src="assets/onepage2/img/logo.png" alt="Logo">
            ...
            <div class="collapse navbar-collapse navbar-responsive-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="page-scroll">
                        <a href="#features">产品及解决方案</a>
                    </li>
                    <li class="page-scroll">
                        <a href="#team">惠腾团队</a>
                    </li>
                    <li class="page-scroll">
                        <a href="#clients">听他们说</a>
                    </li>
                    <li class="page-scroll">
                        <a href="#portfolio">下载中心</a>
                    </li>
                    <li class="page-scroll">
        ...
        <div class="carousel-inner text-uppercase" role="listbox">
            ...
            <div class="item carousel-item-one active">
                <div class="container">
                    ...
                    <a href="#" class="carousel-position-three animate-delay btn-brd-white" data-animation="animated fadeInUp">了解更多</a>
                </div>
            </div>
                ...
                <div class="center-block">
                    <div class="center-block-wrap">
                        <div class="center-block-body">
                            ...
                            <a href="#" class="animate-delay btn-brd-white" data-animation="animated fadeInUp">了解更多</a>
                        </div>
                    </div>
                </div>
            </div>
...
<div class="page-content">
                ...
                <div class="subscribe-body">
                    <form class="form-wrap input-field">
                        <div class="form-wrap-group">
                            <input type="name" class="form-control" id="name" placeholder="您的尊称">
                        </div>
                        <div class="form-wrap-group border-left-transparent">
                            <input type="telephone" class="form-control" id="email" placeholder="您的电话">
                        </div>
                        <div class="form-wrap-group">
                            <button type="submit" class="btn-danger btn-md btn-block">注册</button>
                        </div>
                    </form>
                </div>
            </div>
    ...
    <section id="features">
        ...
        <div class="features-bg">
            <div class="container">
                    ...
                    <div class="col-md-6 md-margin-bottom-70">
                        <div class="features">
                            ...
                            <div class="features-in">
                                <h3><a href="#">企业资产管理</a></h3>
                                <p>Enterprise assets management system</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="features">
                            ...
                            <div class="features-in">
                                <h3><a href="#">企业网站建设</a></h3>
                                <p>Enterprise website construction</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row margin-bottom-80">
                    <div class="col-md-6 md-margin-bottom-70">
                        <div class="features">
                            ...
                            <div class="features-in">
                                <h3><a href="#">基于GIS的政务系统</a></h3>
                                <p>Government system based on GIS</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="features">
                            ...
                            <div class="features-in">
                                <h3><a href="#">其他软件定制</a></h3>
                                <p>Other customized softwares development</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <center>
                    <a href="#" class="btn-brd-danger">申请免费试用</a>
                </center>
            </div>
        </div>
        <!-- Features END -->
            ...
            <div class="clients-bg">
                <div class="container">
                    <div class="heading-blue">
                        <h2>超过 <strong>30个</strong> 合作伙伴</h2>
                        <p>来听听来自他们的声音</p>
                    </div>
                    <!-- //end heading -->
    ...
    <section id="portfolio">
        <div class="portfolio">
            <div class="container">
                <div class="heading">
                    <h2>下载 <strong>中心</strong></h2>
                </div>

                <div class="cube-portfolio">
                    <div id="filters-container" class="cbp-l-filters-alignCenter">
                        <div data-filter="*" class="cbp-filter-item-active cbp-filter-item">所有资源 </div>
                        <div data-filter=".ecommerce" class="cbp-filter-item"> 技术文档 </div>
                        <div data-filter=".admin" class="cbp-filter-item"> 用户手册</div>
                        <div data-filter=".corporate" class="cbp-filter-item">售后支持</div>
                        <div data-filter=".retail" class="cbp-filter-item"> 解决方案 </div>
                    </div>
                    <div class="row">
    ...
    <section id="contact">
                        ...
                        <div class="form">
                            <div class="form-wrap">
                                <div class="form-wrap-group">
                                    ...
                                    <input type="text" placeholder="您的主题" class="border-top-transparent form-control">
                                </div>
                                <div class="form-wrap-group border-left-transparent">
                                    <input type="text" placeholder="您的邮箱" class="form-control">
                                    <input type="text" placeholder="您的电话" class="border-top-transparent form-control">
                                </div>
                            </div>
                        </div>
                        <textarea rows="8" name="message" placeholder="写在这里" class="border-top-transparent form-control"></textarea>
                        <button type="submit" class="btn-danger btn-md btn-block">联系我们</button>
                    </div>
                </div>
                <!-- //end row -->
            </div>
        ...
        <div class="footer-copyright">
            ...
            <ul class="copyright-socials">
                ...
                <P>Copyright &copy; 2018.该网站版权归甘肃惠腾科技有限公司所有.</P>
            </div>
        </div>
