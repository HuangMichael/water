...
public class ConstantUtils {
    ...
    public static final String CONTEXT_PATH = "E:/dev/project2018/water/src/main/webapp/";  //上下文路径
    public static final String GEN_FILE_PATH = "E:/dev/project2018/water/";  //上下文路径
